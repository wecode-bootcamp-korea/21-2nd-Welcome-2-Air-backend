...
- 국내 1위 항공사 [대한항공](https://store.kakaofriends.com/)의 사이트를 모티브한 팀 협업 프로젝트
...
- 이 프로젝트는 [대한항공](https://store.kakaofriends.com/) 사이트를 참조하여 학습목적으로 만들었습니다.
